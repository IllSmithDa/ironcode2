...
import languageSelectImg from '@/assets/language_selection.webp';
import conceptSelectImg from '@/assets/concept_selection.webp';
import './About.scss';
...
export default function About() {
  ...
  return (
    <>
     <section className={`about-container ${darkMode ? 'dark': ''}`}>
      <h2>Purpose</h2>
      <p>
    ...
    <section className={`about-container ${darkMode ? 'dark': ''}`}>
      ...
      <Image src={conceptSelectImg} alt='concept select example' />
      <p>
    ...
    <section className={`about-container ${darkMode ? 'dark': ''}`}>
      ...
      <Image src={languageSelectImg} alt='language select example' />
      <p>
    ...
    <section className={`about-container bottom-section ${darkMode ? 'dark': ''}`}>
      <h3>Questions?</h3>
